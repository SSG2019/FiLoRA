...
def set_seed(seed: int):
    os.environ["CUBLAS_WORKSPACE_CONFIG"] = ":16:8"  # :16:8, :4096:8
...
##############
# mrpc_dataset = load_dataset("glue", "rte")
...
for n,p in model_filora.named_parameters():
    ...
    elif n.endswith(".R") and p.requires_grad:
        loraR_params.append(p)
